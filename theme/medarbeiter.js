...
/**
 * medarbeiter theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { medarbeiterTheme } from './medarbeiter';
 *   import './medarbeiter.css';
 */
export const medarbeiterTheme = {
  name: 'medarbeiter',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #28261f)",
    "--color-background-body": "light-dark(#faf8f3, #1c1b16)",
    "--color-background-card": "light-dark(#ffffff, #1c1b16)",
    "--color-background-popover": "light-dark(#ffffff, #1c1b16)",
    "--color-background-muted": "light-dark(#f5f2ea, #1c1b16)",
    "--color-background-inverted": "light-dark(#1c1917, #faf9f5)",
    "--color-accent": "light-dark(#e1b025, #e5bc44)",
    "--color-accent-muted": "light-dark(#f7edd2, #3a3012)",
    ...
    "--color-text-primary": "light-dark(#1c1917, #faf9f5)",
    "--color-text-secondary": "light-dark(#67625a, #a9a49a)",
    "--color-text-disabled": "light-dark(#a8a29e, #57534e)",
    "--color-text-accent": "light-dark(#7c5f05, #eece6d)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#231a02, #231a02)",
    "--color-on-success": "light-dark(#ffffff, #171717)",
    "--color-on-error": "light-dark(#ffffff, #171717)",
    "--color-on-warning": "#171717",
    "--color-icon-accent": "light-dark(#8f6e06, #eece6d)",
    ...
    "--color-warning": "light-dark(#6e3500, #ffc9a2)",
    "--color-success-muted": "light-dark(#c5e5c0, #84c9803D)",
    "--color-error-muted": "light-dark(#facecb, #ff9e973D)",
    "--color-warning-muted": "light-dark(#fad0b5, #ffa2583D)",
    "--color-border": "light-dark(#1c191714, #FFFFFF1A)",
    "--color-border-emphasized": "light-dark(#d8d2c6, #57534e)",
    "--color-skeleton": "light-dark(#ece2c9, #3a3529)",
