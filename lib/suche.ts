...
const SEITEN: Ort[] = [
  ...
  {label: 'Dienstfahrzeug', href: '/fahrzeug', sinn: 'fahrzeug', recht: 'spesen.erfassen', woerter: 'tanken laden tankbeleg service auto wagen kfz'},
  ...
  {label: 'Fahrzeugbelege abrechnen', href: '/fahrzeug/pruefen', sinn: 'abrechnen', recht: 'spesen.pruefen', woerter: 'dienstfahrzeug tankbelege fälle'},
...
function aktionen(heute: string): Ort[] {
  return [
    ...
    {
      label: 'Fahrzeugfall anlegen',
      href: '/fahrzeug?neu',
      sinn: 'hinzufuegen',
      recht: 'spesen.erfassen',
      zusatz: 'Tank-, Lade- und Servicebelege sammeln',
      woerter: 'tanken tankbeleg dienstfahrzeug neu',
    },
    {
