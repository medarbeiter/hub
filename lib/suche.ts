...
const SEITEN: Ort[] = [
  ...
  {label: 'Dienstfahrzeug', href: '/fahrzeug', sinn: 'fahrzeug', recht: 'fahrzeug.erfassen', woerter: 'tanken laden tankbeleg service reparatur auto wagen kfz'},
  ...
  {label: 'Fahrzeugbelege abrechnen', href: '/fahrzeug/pruefen', sinn: 'abrechnen', recht: 'fahrzeug.abrechnen', woerter: 'dienstfahrzeug tankbelege servicefälle'},
...
function aktionen(heute: string): Ort[] {
  return [
    ...
    },
    {
      ...
      href: '/fahrzeug?neu=tanken',
      sinn: 'hinzufuegen',
      recht: 'fahrzeug.erfassen',
      zusatz: 'Tank- oder Ladebeleg des Dienstfahrzeugs',
      woerter: 'tanken laden tankbeleg dienstfahrzeug neu',
    },
    {
